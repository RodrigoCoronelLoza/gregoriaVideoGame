...
const historyVData = {
  ...
  15: "",
  16: "Fuera del colegio Miguel esta buscando alguien con quien hablar, Mónica lo ve y camina rápido hacia Miguel. <br/> —“No era un novio… es un hombre mucho mayor” —dice Miguel, con la voz quebrada por la rabia.<br/> Mónica se queda helada. Le tiembla la barbilla y, sin poder evitarlo, las lágrimas le nublan la vista.<br/> Saca de su mochila unas hojas arrugadas y manchadas. Miguel lee frases que parecen gritarle en la cara: <br/>No puedo más. Me dijo que era mi culpa. Si no lo hago, me deja.",
  17: "Mónica traga saliva y baja la voz: <br/>—“Miguel… creo que María está embarazada.”<br/>Le muestra otras páginas del cuaderno:<br/>Él no quiere que lo tenga. Me dijo que debería haberme cuidado, pero no sabía qué hacer. Dice que hay formas de solucionarlo, pero estoy asustada.<br/>Miguel siente cómo la rabia se mezcla con impotencia. Mónica lo mira, intentando contener el temblor en sus manos.<br/>(Pensamiento de Mónica): “Si seguimos la pista, tal vez lleguemos a tiempo… pero no podemos solos.”",
...
const historyFData = {
  ...
  4: "A veces, la conversación que no tuvimos a tiempo puede costar una vida. Hablar de sexualidad, derechos y prevención es urgente, siempre.",
  5: "",
};
