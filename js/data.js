...
const textVData = {
  ...
  1: "",
  2: [
    "Pregunta dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ",
    "ELIJO OPCION 111111 ELIJO OPCION 111111 ",
    "ELIJO OPCION 222222 ELIJO OPCION 222222",
    "ELIJO OPCION 333333 ELIJO OPCION 333333",
  ],
};
...
const imagesVData = {
  ...
  1: "blackback.jpeg",
  2: ["blackback.jpeg", "strawberry.jpg"],
};

const jumpsVData = {
  0: "",
  1: [
    { newLayout: "A", numberOfPage: 2 },
    { newLayout: "B", numberOfPage: 5 },
  ],
  2: [
    { newLayout: "A", numberOfPage: 2 },
    { newLayout: "B", numberOfPage: 5 },
    { newLayout: "B", numberOfPage: 10 },
  ],
};
/* RAMA A*/
const titlesAData = {
...
const instructionsAData = {
  0: "",
  1: "María estaba más callada, evita ciertas conversaciones y ya no se queda con nosotras en los recreos. ¿Qué hubieras hecho tú?",
  2: "Explora las páginas del diario de María. ¿Qué te está intentando decir?",
  3: "Relaciona las frases del diario de María con las emociones que podrían reflejar.",
  4: "",
  5: "Lee las frases a continuación y responde si son verdaderas o falsas:",
  6: "",
  7: "¿Qué pensamientos pudo tener María al decidir no contar nada? Ordena estas frases como crees que ella lo sintió.",
  8: "Lee estas frases y decide si representan amor sano o señales de alerta. Une cada una con su interpretación real.",
  9: "",
  10: "Encuentra las parejas que revelan mensajes escondidos entre las publicaciones eliminadas. ¿Qué imágenes y frases podrían haber sido señales?",
  11: "¿Puedes reconocer cuáles de estas afirmaciones son señales de una cultura del silencio que puede poner en riesgo a alguien?",
};

const feedbackAData = {
  0: "",
  1: "Prestar atención, no minimizar lo que se cuenta, crear un espacio seguro y ofrecer orientación profesional son formas efectivas de acompañar.",
  2: "Estas frases reflejan emociones profundas que muchas veces se callan. Reconocerlas es el primer paso para pedir ayuda",
  3: "Identificar emociones es el primer paso para pedir ayuda. Reconocer estas frases puede ayudarnos a detectar señales ocultas en personas cercanas",
  4: "",
  5: "",
  6: "Fomenta confianza y puede desbloquear a Luisa en una siguiente escena",
  7: "A veces el silencio no es decisión, es miedo aprendido.”",
  8: "¡Bien! El amor no necesita pruebas ni control. Reconocer estos mitos nos ayuda a prevenir relaciones dañinas.",
  9: "",
  10: "Muchos jóvenes no pueden contar lo que viven, pero sus redes sí lo gritan. Presta atención a los cambios, símbolos y silencios.",
  11: "",
};

const historyAData = {
  0: "Al principio eran cosas pequeñas: dejó de reírse con nuestros chistes, y sus respuestas eran vagas y sarcásticas.",
  1: "Monica piensa: </br> Noté que algo pasó, pero no pregunté mucho más. Quizás lo  hubiera hecho si hubieramos sido más amigas, pero siempre estaba ocupada en el puesto de su familia. </br></br>Mónica observa el pupitre vacío donde solía sentarse María.",
  2: "Cuando la profe Inés me pidió que devolviera esa libreta extraviada y sin nombre, me fue difícil reconocer su letra... pero estaba segura que era de ella. No es un cuaderno de clases, sino un Diario personal. Aún no logro descifrarlo por completo.",
  3: "¿Acaso fui tan ciega? Ni siquiera puedo creer que sea su cuaderno. Los suyos siempre eran tan pulcros, mientras este es... Con razón ni la profe Inés se dio cuenta.”</br>“No entiendo todo lo que escribió, pero sí la siento a ella. </br> Guardaré este cuaderno por ahora",
  4: "Un día, un extraño vino esperarla a la salida y se fueron juntos en un auto. Yo pensaba que era su hermano mayor, el que vive en Viacha, pero luego me enteré que no era él.",
  5: "Poco después de aquella vez que la vinieron a recoger, María apareció con un celular nuevo. Con un estuche rosado y una cámara muy buena. “Me la regaló un admirador”, dijo haciendose la interesante. Luisa me susurró: “Su chico ha debido ser para que puedan hablar sin que sus papás se enteren”.</br> </br>En ese momento,  sentí envidia. Pensé que era emocionante tener un teléfono solo para ti, sin que nadie lo controle. Deberia buscar ese numero talvez si la llamo allí si conteste.",
  6: "Después de todo lo que había visto, decidí hablar con las chicas que más estaban con María. Tal vez alguna tuviera su número, o supiera algo más del chico del celular rosado.”“Pero todas se miraron con caras largas, incómodas. Nadie dijo nada por un rato.”</br>Mónica: —¿Ninguna sabe cómo contactarla?</br>Luisa (tras una pausa): —Ya no hablaba tanto con nosotras… últimamente estaba muy rara.",
  7: "Luisa fue la primera en hablar:</br></br>—No le pedí el número… ya me olía que no me lo iba a dar.</br>—Se ha escapado con su chico de seguro —dijo la de Acshon.</br>—¿Pero cuál chico? —pregunté. Nadie supo decirme. Solo risas incómodas. </br>Y nadie me supo responder con certeza. Entre risas incómodas y silencios largos, me quedó claro que sabían menos de lo que pensaban… o no querían aceptar lo que ya sospechaban. nada nuevo",
  8: "Entonces recordamos una charla que habíamos tenido semanas atrás, mientras esperábamos el micro. Luisa estaba molesta porque se había peleado con Ramiro, su chico. En medio del chisme, María soltó una frase que ahora nos retumbaba en la cabeza: </br> —“No te enojes porque te cela, si no fuera celoso deberías preocuparte. Es porque te quiere mucho que se intensea”.</br></br>Ese rato nos reimos, pero ahora… solo nos quedamos calladas.",
  9: "Narración interna de Mónica:</br>—Buscando en su Insta, noté que había eliminado casi todo. La última foto no era selfie, sino una tomada por alguien más. María señalaba algo fuera del cuadro. El pie de foto decía: “Lo mejor nunca se sube ;)”",
  10: "Buscando en su Insta, recién noté que María había borrado muchas selfies, como si borrara capítulos de su vida. La última imagen no era selfie, sino una foto tomada hace unos tres meses por alguien más. En ella aparece señalando algo fuera de cuadro. En el pie de foto - ‘Lo mejor nunca se sube ;)’",
...
const instructionsBData = {
  ...
  10: "Encuentra las parejas que revelan mensajes escondidos entre las publicaciones eliminadas. ¿Qué imágenes y frases podrían haber sido señales?",
  11: "¿Puedes reconocer cuáles de estas afirmaciones son señales de una cultura del silencio que puede poner en riesgo a alguien?",
  12: "Lee cada pensamiento o creencia y une con su reflexión correcta. ¿Qué aprendizaje puedes extraer de esta situación?",
  13: "Ordena estas frases en la secuencia que revela cómo se fue ocultando y normalizando una relación que debería haber despertado alertas.",
};
...
const feedbackBData = {
  ...
  10: "Muchos jóvenes no pueden contar lo que viven, pero sus redes sí lo gritan. Presta atención a los cambios, símbolos y silencios.",
  11: "",
  12: "La lealtad verdadera también se demuestra cuando ayudamos a quien no puede pedir ayuda abiertamente",
  13: "Las relaciones que comienzan con secretos, aislamiento y control suelen escalar. Identificar estos patrones es clave para prevenir daños",
};
...
const historyBData = {
  ...
  10: "Buscando en su Insta, recién noté que María había borrado muchas selfies, como si borrara capítulos de su vida. La última imagen no era selfie, sino una foto tomada hace unos tres meses por alguien más. En ella aparece señalando algo fuera de cuadro. En el pie de foto - ‘Lo mejor nunca se sube ;)’",
  11: "Mientras veíamos esa foto notamos que Luisa se le escapó un grito ahogado. Con lo blanca que se puso blanca, no tuvimos que increparla. Ella sabía que sabíamos que sabía algo. </br></br> Bajó la mirada y se quedó en silencio. Luego, con voz baja, me confesó que al principio  María le pedía que la cubriera cuando salía con “su patito”, así le decía. “Luego solo se empezó a faltar sin más“</br></br>Luisa pensaba que la estaba ayudando, que era una sororidad entre amigas con chicos.",
  12: "Por su parte, Laura igual admitió que María le pidió cubrirla una vez, pero ella no lo hizo.</br></br>- Me dió miedo y por eso tampoco la acusé, solo no me quería meter en problemas.",
  13: "Le preguntamos por detalles, y en realidad no sabía mucho del patito</br></br>-Siempre le pedi chisme, pero nunca me dijo nada. Solo sé que no viene a nuestro cole, y por eso se escapaban. </br></br>-A qué cole irá? - Preguntó la de Laura </br></br>-Y si ese chico no va al colegio? - Pregunté, recordando al chico del auto.",
};
