...
const historyVData = {
  1: "",
  2: "Esto no es un juego. Es una carrera contra el tiempo. Debes atar cabos, leer entre líneas y tomar decisiones que podrían cambiar una historia que aún no termina.",
  3: "",
  ...
  6: "",
  7: "Deciden revisar más a fondo el cuaderno. Las hojas están rasgadas, otras apenas sujetas al espiral. Entre tachaduras furiosas, sobresalen frases que parecen pedir ayuda. Miguel pasa las páginas con cuidado, como si fueran a romperse en sus manos.",
  ...
  11: "Mónica aprieta el celular entre sus manos.<br/>—“Esto no lo borró por accidente. Alguien le pidió que lo hiciera.”<br/>Miguel responde: “O no quería que nadie encontrara algo…”<br/> El silencio entre ambos se vuelve pesado.",
  ...
  18: "Se sientan juntos en un rincón apartado. Miguel enciende el celular rosado y reinstala las redes sociales de María.<br/>Al abrir los mensajes, encuentran respuestas de un usuario sin foto de perfil:<br/>—“No hables con nadie más.”<br/>—“Te espero, no tardes.”<br/>La sensación de control y amenaza es clara. Miguel respira hondo para no romper el teléfono de rabia.",
  ...
  25: "Golpean la puerta, pero nadie responde. Detrás, Miguel detecta un pasillo que conecta con un alojamiento. Decide entrar.",
...
const imagesVData = {
  ...
  4: "blackback.jpeg",
  5: "blackback.jpeg",
  6: ["blackback.jpeg", "strawberry.jpg"],
  7: "blackback.jpeg",
  9: "blackback.jpeg",
  10: "blackback.jpeg",
  11: "blackback.jpeg",
  ...
  13: "blackback.jpeg",
  14: "blackback.jpeg",
  15: ["blackback.jpeg", "strawberry.jpg"],
  16: "blackback.jpeg",
  17: "blackback.jpeg",
  18: "blackback.jpeg",
  19: "blackback.jpeg",
  20: ["blackback.jpeg", "strawberry.jpg"],
  21: "blackback.jpeg",
  22: "blackback.jpeg",
  23: "blackback.jpeg",
  24: "blackback.jpeg",
...
const historyAData = {
  ...
  32: "Mientras camina por el pasillo, Mónica piensa: “Hablar es la única forma de ayudarla… aunque me dé miedo lo que pueda pasar después.”</br>Sale del colegio decidida a encontrar a los padres de María.",
};
...
const historyHData = {
  ...
  3: "",
  4: "En el pasillo, Miguel comenta a una amiga que su hermana no llegó a casa. <br/> Ella se encoge de hombros:<br/>—Seguro se fue de fiesta… a veces pasa.<br/>Miguel la mira con molestia.<br/>—Mi hermana es pequeña, no hace esas cosas.",
  5: "Otro compañero, que ha escuchado la conversación, interviene con tono burlón: <br/>—O capaz se fue a un motel con su novio. <br/> Miguel siente un calor subirle al rostro y responde:<br/>—No hables estupideces.<br/>Ellos se ríen y dicen:<br/>—Ahora todos hacen eso.<br/><br/>Las palabras lo hieren más de lo que quiere admitir.",
  ...
  22: "",
  23: "Miguel está sentado en la mesa de la cocina. La luz fría de la mañana entra por la ventana, resaltando las ojeras de su madre. Ella, con los ojos rojos de tanto llorar, le toma las manos con fuerza.<br/>—“No me di cuenta… pensé que estaba bien. Yo… debí escucharla más.”<br/>Miguel siente un nudo en la garganta. La culpa de su madre se mezcla con la suya propia.",
  24: "—“Papá no debió pelearse en el colegio” —dice Miguel, recordando la escena.<br/>Él había ido después y logró hablar con las amigas de María. Sus respuestas fueron frías y cargadas de burlas:<br/>—“Tu papá te riñe por hablar con esas chicas, ellas son la mala compañia, siempre metiéndose con noviecitos y tratando de decir que Maria es igual…”<br/>Miguel niega con firmeza: —Porque mentirian sus amigas, talvez María si  tenía novio. Quizas es todo un malentendido.”<br/>Pero por dentro, aprieta los dientes. ¿Por qué no quieren ver lo que es tan obvio?",
  ...
  31: "Con el estómago revuelto, Miguel decide volver al colegio. Necesita más respuestas. Si alguien vio a María con ese hombre, tal vez en las inmediaciones o a la salida, podrá confirmar lo que teme.",
};
